...
<div class="large-6 columns main-content">
        ...
        <form action="<?=base_url();?>/taskpanel/addpanel" name="" id="" method="post">
          <table class="addtask">
                ...
                <tr>
                  <td>   <input type="text" style="width:180px;" placeholder='Enter Task Name' name="task_name" id="task_name" > </td>
               ...
               <!--   <td>  <input type="checkbox" class="checkbox" style="width:100px;"  name="completed" id="completed" value="1"> </td>-->
                  ...
                  <td>  <input type="submit" value="Add Task" style="margin-bottom:15px;" name="submit" id="submit"> </td>
              </td>
              </tr>
